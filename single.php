...
<div class="container-shadow container-1000">
    <div class="polygon">
        <img src="<?php echo get_the_post_thumbnail_url( $post->ID, 'blog-image-main' ); ?>">
        <div class="container-inner">
            <?php esc_html( the_title( '<h2>', '</h2>' ) ); ?>
            <div class="flex-container">
                <small class="label">published by</small>
                <small><b>
                    <?php echo get_the_author_meta('display_name', get_post_field( 'post_author', $post->ID ) ); ?>
                </b></small>
